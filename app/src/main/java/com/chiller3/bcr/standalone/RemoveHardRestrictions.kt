...
private fun mainInternal() {
    ...
    val changed = removeRestriction("com.system.superiormonitor", Manifest.permission.READ_CALL_LOG, 0)
    val suffix = "from com.system.superiormonitor for ${Manifest.permission.READ_CALL_LOG}"
